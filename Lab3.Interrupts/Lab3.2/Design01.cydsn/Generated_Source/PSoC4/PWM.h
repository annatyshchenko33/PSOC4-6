...
#define PWM_PWM_STOP_EVENT                 (1lu)
#define PWM_PWM_MODE                       (5lu)
#define PWM_PWM_OUT_N_INVERT               (0lu)
#define PWM_PWM_OUT_INVERT                 (1lu)
#define PWM_PWM_ALIGN                      (0lu)
#define PWM_PWM_RUN_MODE                   (0lu)
#define PWM_PWM_DEAD_TIME_CYCLE            (10lu)
