...
#define CY_BLE_SCN_PKT_0_INDEX_ADVERTISING_INTERVAL   (0x03u)
#define CY_BLE_SCN_PKT_0_INDEX_BLUETOOTH_DEVICE_ADDRESS   (0x07u)
#define CY_BLE_SCN_PKT_0_INDEX_ROLE   (0x10u)
