...
#define PWM_Green_QUAD_AUTO_START                (1lu)
...
#define PWM_Green_PWM_STOP_EVENT                 (1lu)
#define PWM_Green_PWM_MODE                       (4lu)
