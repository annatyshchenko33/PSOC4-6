...
module BLE_v3_66_0 (
	...
	cy_clock_v1_0
		#(.id("7b266bc3-bfb7-46e3-9263-11badd89c793/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("feaecf0e-7666-4dce-82be-b60f72748491"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ebe9f6d1-252e-49ba-af16-9131d3d1d2f5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
