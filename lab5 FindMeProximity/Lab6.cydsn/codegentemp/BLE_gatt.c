    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x25u] = {
    /* Device Name */
    (uint8)'A', (uint8)'n', (uint8)'y', (uint8)'a',
    ...
    (uint8)'P', (uint8)'r', (uint8)'o', (uint8)'x', (uint8)'i', (uint8)'m', (uint8)'i', (uint8)'t', (uint8)'y',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[18] }, /* CapSense Proximity */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0012u, (void *)&cyBle_attValues[19] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x10u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x0010u, {{0xCAA1u, NULL}}                           },
    { 0x000Eu, 0xCAA1u /* CapSense Proximity                  */, 0x01100000u /* ntf    */, 0x0010u, {{0x0001u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0901u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0010u, {{0x0012u, (void *)&cyBle_attValuesLen[7]}} },
};
